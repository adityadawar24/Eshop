...
const totalAmount = Math.max(totalCost*100,1000);
  ...
  return (
    ...
    <div className='dem'><p><b>Card number(demo):4111 1111 1111 1111</b></p>
    <p><b>Expiry: provide a valid expiry date </b> </p>
    <p><b>CVV:any 3 digit number</b></p>
    </div>
    </div>
    {paymentData && (
